...
import Img4 from "../Components/imgs/IMG_2648.gif";
import Imgs from "../Components/imgs/image3.gif";
import Img5 from "../Components/imgs/image4.gif";
import BgImg from "../Components/imgs/image.png";
  ...
  return (
    <div className="Home">
      ...
      <nav className="navbar container navbar-expand-lg navbar-light ">
        ...
        <img src={BgImg} className='w-100 oioi' ></img>
        <div className="row pb-5 ">
          <div className="col-12 col-md-4">
          </div>
          <div className="col-12 col-md-4 "  style={{ height :"80vh" }}>
            <img
              src={Img3}
              className=" mx-auto w-100 d-block Img pt-5"
              // style={{ borderradius: "100%" }}
              alt="..."
            ></img>
            < h1 className="text-center"> SOLD OUT </h1>
            <h2 className="pb-5 text-center">
              <a href="https://opensea.io/collection/babydoodleapesofficial" target="_blank">
                View On Opensea
              </a>
            </h2>
          </div>
      ...
      <div className="container">
        ...
        <div className="row RowTwo py-5 align-items-center">
          <div className="col-12 col-md-6">
            <img className="mx-100 d-block rounded w-100 " src={Img4}></img>
          </div>
          <div className="col-12 col-md-6">
            <h1>Mutants</h1>
            ...
            <div className="row">
              ...
              {/* <div className="BtnDivB mt-4 py-3">
              <a href="https://opensea.io/collection/babydoodleapesofficial" target='_blank'>
                <h5 className="text-white  text-center w-100">
